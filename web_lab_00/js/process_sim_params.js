...
let simParams = {
  ...
  simStepRepeats : 20, // 20, // integer number of unit updates between display updates
  ...
  updateDisplayTimingMs : 100, // 100, // real time milliseconds between display updates
